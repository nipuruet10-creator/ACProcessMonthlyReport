            ...
            <div class="grid grid-cols-1 sm:grid-cols-3 gap-3">
              ...
              <div>
                ...
                ${(typeof MonthlyInputView !== 'undefined' && !MonthlyInputView.isHodPointUnlocked()) ? `
                  <input type="number" id="entry-task-points" value="${currentPts}" placeholder="—" readonly
                ...
                ` : `
                  <input type="number" id="entry-task-points" value="${currentPts}" placeholder="—" step="5" min="0" max="100"
